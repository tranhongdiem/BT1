...
public class BuyingComputerFlow<T extends ComputerEssentialComponent> implements ComputerPriceType {
    ...
    public void checkout(){
        ...
        billingAddressComp.firstname().sendKeys("firstname");
        billingAddressComp.lastname().sendKeys("lastname");
        billingAddressComp.email().sendKeys("email@email.com");
        billingAddressComp.selectCountry("United States");
        billingAddressComp.selectState("Alabama");
        billingAddressComp.city().sendKeys("City");
        billingAddressComp.address1().sendKeys("Address 1");
        billingAddressComp.zipCode().sendKeys("1234");
        billingAddressComp.phoneNumber().sendKeys("9999999999");
